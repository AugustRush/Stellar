...
extension UIView: DriveAnimateBehaviors {
    ...
    fileprivate func snapBehavior<T: Vectorial>(_ damping: CGFloat, from: T, to: T, render: @escaping (T) -> Void) -> UIDynamicBehavior where T.VectorType == CGPoint {
    ...
    fileprivate func snapBehavior<T: Vectorial>(_ damping: CGFloat, from: T, to: T, render: @escaping (T) -> Void) -> UIDynamicBehavior where T.VectorType == CGRect {
    ...
    fileprivate func attachmentBehavior<T: Vectorial>(_ damping: CGFloat, frequency: CGFloat, from: T, to: T, render: @escaping (T) -> Void) -> UIDynamicBehavior where T.VectorType == CGPoint {
        let item = DynamicItem(from: from, to: to, render: render)
    ...
    fileprivate func attachmentBehavior<T: Vectorial>(_ damping: CGFloat, frequency: CGFloat, from: T, to: T, render: @escaping (T) -> Void) -> UIDynamicBehavior where T.VectorType == CGRect {
        let item = DynamicItem2(from: from, to: to, render: render)
        let point = CGPoint(x: 0.0, y: item.referenceChangeLength)
